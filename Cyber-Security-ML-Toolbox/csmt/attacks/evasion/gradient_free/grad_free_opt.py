...
from csmt.zoopt.gradient_free_optimizers  import RandomSearchOptimizer,BayesianOptimizer,HillClimbingOptimizer,\
    StochasticHillClimbingOptimizer,SimulatedAnnealingOptimizer,GridSearchOptimizer,\
        ParticleSwarmOptimizer,EvolutionStrategyOptimizer,OneDimensionalBayesianOptimization
...
class GradFreeMethod():
    ...
    def __init__(self,estimator,eps,eps_step,max_iter,norm):
