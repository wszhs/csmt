...
if __name__ == "__main__":
    ...
    target_model.load_state_dict(torch.load("tests/test_orig_attack/AlexNet_model.pth", map_location=torch.device('cpu')))
    target_model.eval()
    test_data = datasets.MNIST(root='tests/test_orig_attack/mnist_data/', train=False, download=False, transform=transforms.ToTensor())
