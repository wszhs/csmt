...
from csmt.figure.visualml.plot_importance import plot_feature_importance_all,plot_vec
...
if __name__=='__main__':
    ...
    for i in range(len_fea):
        feature_importances[i]=mutual_information(X[:,i],y,bins)
    print(feature_importances)

    # plot_feature_importance_all(feature_importances,max_num_features=10)
    
    plot_vec(feature_importances,'Entropy_importance')
