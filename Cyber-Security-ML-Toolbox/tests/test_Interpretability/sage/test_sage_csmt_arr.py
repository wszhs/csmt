...
if __name__=='__main__':
    ...
    orig_models_name_arr=[['lr'],['rf'],['xgboost'],['mlp_torch'],['idsnet_torch'],['deepnet_torch'],['rnn_torch'],['lstm_torch'],['alertnet_torch']]
#     orig_models_name_arr=[['rnn_torch'],['lstm_torch'],['alertnet_torch']]
    for i in range(len(orig_models_name_arr)):
          ...
          plot_vec(attr,'/Users/zhanghangsheng/Documents/my_code/Cyber-Security-ML-Toolbox/importance/kitsune/scan/'+datasets_name+orig_models_name[0])
