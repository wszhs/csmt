...
def plot_different_datasets():
    # ids17 kitsune
    sheet_name='ids17'
    df=pd.read_excel('/Users/zhanghangsheng/Desktop/实验数据/ETA/1.2-不同攻击数据集对比2.xlsx',sheet_name=sheet_name)
    x=[1,2,3,4]
...
def plot_transfer():
    ...
    df = pd.read_excel('/Users/zhanghangsheng/Desktop/实验数据/ETA/2.1-不同基模型的迁移性.xlsx',sheet_name=sheet_name)
    # print(df)
...
def plot_diff_feature():
    ...
    # ids17 kitsune
    sheet_name='ids17'
    df = pd.read_excel('/Users/zhanghangsheng/Desktop/实验数据/ETA/2.2-是否使用重要特征.xlsx',sheet_name=sheet_name)
    color=['#4272b1','#285085']
...
def plot_del_feature_line():
    # matplotlib.style.use('ggplot')
    df = pd.read_excel('/Users/zhanghangsheng/Desktop/实验数据/ETA/3.1-删除非鲁棒特征.xlsx',sheet_name='ids17-botnet')
    print(df)
    x=df['dim']
...
def plot_use_feature_line():
    # matplotlib.style.use('ggplot')
    df = pd.read_excel('/Users/zhanghangsheng/Desktop/实验数据/ETA/3.2-只用非鲁棒特征.xlsx',sheet_name='ids17-botnet')
    print(df)
    x=df['dim']
    x_label = [1.5, 2.5, 3.5, 4.5, 5.5,6.5,7.5,8.5,9.5,10.5,11.5]
    color=['#f1595e','#ff1887','#8971e1','#007417','#56cefc']
...
def plot_similar_line():
    # matplotlib.style.use('ggplot')
    df = pd.read_excel('/Users/zhanghangsheng/Desktop/实验数据/ETA/3.3-不同模型之间的非鲁棒特征相似性.xlsx',sheet_name='ids17-ddos-1')
    print(df)
    # x=df['dim']
    x_label = [1.5, 2.5, 3.5, 4.5, 5.5,6.5,7.5,8.5,9.5,10.5,11.5]
    color=['#f1595e','#ff1887','#8971e1','#007417','#56cefc']
