...
def plot_weight():
    ...
    df=pd.read_excel('/Users/zhanghangsheng/Desktop/实验数据/CARE/权重变化.xlsx',sheet_name=sheet_name)
    color=['#f3cab3','#5e0000','#c15a4c','#9e282f']
    color=['#d8d9dc','#f2e6dc','#dfbac8','#a784a7','#454551']
    # color=['#85bbef','#7084ee','#8970ef','#df81e1','#df39cb']
    color=['#d8d9dc','#bcd6e6','#5e98c2','#4272b1','#285085']
...
def plot_eps():
    # spam ids17
    sheet_name='ids17'
    df = pd.read_excel('/Users/zhanghangsheng/Desktop/实验数据/CARE/不同的eps.xlsx',sheet_name=sheet_name)
    K=5
...
def plot_problem_attack():
    ...
    marker=['o','x','*','^','s']
    color=['#f1595e','#ff1887','#8971e1','#007417','#56cefc']
    df=pd.read_excel('/Users/zhanghangsheng/Desktop/实验数据/CARE/问题空间攻击.xlsx',sheet_name=sheet_name)
    print(df)
